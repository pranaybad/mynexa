...
const Service = () => {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap -m-4">
      <Link href={'/product/lift-association'}><div className="lg:w-1/5 md:w-1/2 p-4 w-full cursor-pointer shadow-lg m-5">
        <a className="block relative h-48 rounded overflow-hidden">
          <img alt="ecommerce" className="object-cover object-center w-full h-full block" src="https://dummyimage.com/420x260"/>
        </a>
        <div className="mt-4">
          <h3 className="text-gray-500 text-xs tracking-widest title-font mb-1">Lift Comapny</h3>
          <h2 className="text-gray-900 title-font text-lg font-medium">AbC</h2>
          <p className="mt-1">₹84000</p>
        </div>
      </div>
      </Link>
      <Link href={'/product/lift-association'}><div className="lg:w-1/5 md:w-1/2 p-4 w-fullcursor-pointer shadow-lg m-5">
        <a className="block relative h-48 rounded overflow-hidden">
          <img alt="ecommerce" className="object-cover object-center w-full h-full block" src="https://dummyimage.com/421x261"/>
        </a>
        <div className="mt-4">
          <h3 className="text-gray-500 text-xs tracking-widest title-font mb-1">Lift Comapny</h3>
          <h2 className="text-gray-900 title-font text-lg font-medium">Xyz</h2>
          <p className="mt-1">₹84000</p>
        </div>
      </div>
      </Link>
      <Link href={'/product/lift-association'}><div className="lg:w-1/5 md:w-1/2 p-4 w-fullcursor-pointer shadow-lg m-5">
        ...
        <div className="mt-4">
          <h3 className="text-gray-500 text-xs tracking-widest title-font mb-1">Lift Comapny</h3>
          <h2 className="text-gray-900 title-font text-lg font-medium">ddd</h2>
          <p className="mt-1">₹84000</p>
        </div>
      </div>
      </Link>
      <Link href={'/product/lift-association'}><div className="lg:w-1/5 md:w-1/2 p-4 w-fullcursor-pointer shadow-lg m-5">
        ...
        <div className="mt-4">
          <h3 className="text-gray-500 text-xs tracking-widest title-font mb-1">Lift Comapny</h3>
          <h2 className="text-gray-900 title-font text-lg font-medium">400 Blows</h2>
          <p className="mt-1">₹84000</p>
        </div>
      </div>
      </Link>
      <Link href={'/product/lift-association'}><div className="lg:w-1/5 md:w-1/2 p-4 w-fullcursor-pointer shadow-lg m-5">
        ...
        <div className="mt-4">
          <h3 className="text-gray-500 text-xs tracking-widest title-font mb-1">Lift Comapny</h3>
          <h2 className="text-gray-900 title-font text-lg font-medium">random</h2>
          <p className="mt-1">₹84000</p>
        </div>
      </div>
      </Link>
